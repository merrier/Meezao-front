/**
 * Created by Yangyue on 2016/7/14.
 */

$(document).ready(function(){

    var par=".create_B_mould";
    ...
    //-------------------新增三级菜单------------------------
    $(par).on("click",".btn-group .btn_add_level3",function(){
        var modal_now=$(".modal_add_menu");
        ...
        submitHandler:function(form){
            ...
            if(par.hasClass("modal_add_level1")){
                ...
                $("tr.menu_level2").each(function(){
                    ...
                    console.log(d_ch_now.substring(0,3));
