...
function getFirstPage(searchInfo,type){
    ...
    $.ajax({
        type: 'GET',
            url: "/MeeZao/AutoReply/AutoReply/Get_art",
        data: {
            page: '1',
            type:type,
            ...
            if(type=='single'){
                ...
                for (var i = data.length - 1; i >= 0; i--) {
                    ...
                    html+=  '<div class="dialog_appmsg_item news_checked_lzm" data-id="' + data[i][0].more_id + '">' +
                        '<div class="dialog_appmsg_data" name="' + data[i][0].more_id + '"> ' +
                        '<div class="appmsg_item_content" style="color:black">' +
                        '<div class="cover_appmsg_item"> ' +
                        '<h4 class="appmsg_title js_title" name="' + data[i][0].more_id + '"> ' +
...
function getInfo(searchInfo,type){
    ...
    $.ajax({
        type: 'GET',
        url: "/MeeZao/AutoReply/AutoReply/get_count",
        data: {
            searchInfo: searchInfo,
            type:type
        },
        success: function (data) {
            ...
            $('.d_menu .showpic_dialog_page2 span:not(".showpic_previous_page2,.showpic_next_page2")').click(function () {
                $(this).addClass("showpic_current_page").siblings().removeClass('showpic_current_page');
            })
            $('.d_menu .showpic_dialog_page2 span').click(function () {
                //alert('我是点击事件');
                var current_page = 1;
                if ($(this).hasClass('showpic_page_disabled')) {
                    ...
                    if($(this).html()=='上一页'){
                        ...
                        if (!$('.showpic_previous_page2').hasClass('showpic_page_disabled')) {
                            if ($('.d_menu .showpic_dialog_page2').find('.showpic_current_page').html() != 1) {
                                $('.d_menu .showpic_dialog_page2').find('.showpic_current_page').removeClass('showpic_current_page').prev().addClass('showpic_current_page');
                            }
                        }
                    }else if($(this).html()=='下一页'){
                        //alert('下一页');
                        if (!$('.showpic_next_page2').hasClass('showpic_page_disabled')) {
                            if ($('.d_menu .showpic_dialog_page2').find('.showpic_current_page').html() != page2) {
                                $('.d_menu .showpic_dialog_page2').find('.showpic_current_page').removeClass('showpic_current_page').next().addClass('showpic_current_page');
                            }
                        }
                    }
                    ...
                    current_page = $('.d_menu .showpic_dialog_page2').find('.showpic_current_page').html();
                    $.ajax({
                        type: 'GET',
                        url: "/MeeZao/AutoReply/AutoReply/Get_art",
                        data: {
...
$(function () {
    ...
    //$("body").delegate(".single", "click", function () {
    ...
    $(".content_title_item").click(function () {
        var $index = $(".content_title_item").index(this);
        $(this).removeClass("box_shadow").siblings().addClass("box_shadow");
        $(".box_content_main").eq($index).show().siblings(".box_content_main").hide();
    });
    /*---------------------------被动添加自动回复 消息自动回复 关键词自动回复点击切换 end--------------------------------------------------*/

    //------------------文字/图片点击切换------------------
    $(".main_choice_item").click(function () {
        var $index = $(".main_choice_item").index(this);
        $(".content_main_showbox").eq($index).show();
        $(".content_main_showbox").eq($index).siblings(".content_main_showbox").hide();
    ...
    $('.d_menu .showpic_dialog_page1 span:not(".showpic_previous_page1,.showpic_next_page1")').click(function () {
        $(this).addClass("showpic_current_page").siblings().removeClass('showpic_current_page');
    })
    $('.showpic_previous_page1').click(function () {
        if (!$('.showpic_previous_page1').hasClass('showpic_page_disabled')) {
            $('.d_menu .showpic_dialog_page1 span').each(function () {
    ...
    $('.d_menu .showpic_dialog_page1 span').click(function () {
        var current_page = 1;
        if ($(this).hasClass('showpic_page_disabled')) {
        } else {
            $('.d_menu .showpic_dialog_page1 span').each(function () {
                if ($(this).hasClass('showpic_current_page')) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "/MeeZao/AutoReply/AutoReply/Get_pic",
                        data: {
                            page: current_page
                        },
                        success: function (data) {
    ...
    $("body").delegate(".dialog_appmsg_data", "click", function () {
                                        //alert('dialog_appmsg_data');
        $(".appmsg_item_bgcheck").hide();
        $('.dialog_appmsg_data').removeClass('this_checked');
        $(this).addClass('this_checked');
        $(this).children(".appmsg_item_bg").hide();
    ...
    $('.main_footer_save_1').click(function () {
        ...
        if (logic_text_img == '2') {
            ...
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Upload_picture",
                data: fd,
                cache: false,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/First_reply",
    ...
    $('.lzm_delete_1').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/First_reply_del",
            data: "id=" + id,
            success: function (data) {
                alert('删除成功');
    ...
    $('.main_footer_save_2').click(function () {
        ...
        if (logic_text_img == '2') {
            ...
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Upload_picture_2",
                data: fd,
                cache: false,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Second_menu",
    ...
    $('.lzm_delete_2').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/Second_menu_del",
            data: "id=" + id,
            success: function (data) {
                alert('删除成功');
                //var goto_url = location.href;
    ...
    $(".rule_sure_new_lzm").click(function () {
        ...
        if(rule){
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Rule_add",
                data: "rule_name=" + rule,
                success: function (data) {
    ...
    $('.keyword_sure').click(function () {
        ...
        if(keyword_text){
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Keyword_add",
    ...
    $('.edit_keyword_lzm').click(function () {
        ...
        if(keyword_text){
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Edit_keywords",
    ...
    $('.text_sure').click(function () {
        ...
        $.ajax({
            type:'POST',
            url: '/MeeZao/AutoReply/AutoReply/'+ajax_url,
            data: {
    ...
    $('.picture_sure_lzm').click(function () {
        ...
        if (rule_id == '') {
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Edit_auto_img",
            ...
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Add_auto_img",
    ...
    $('.rule_delete_all_lzm').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/All_delete",
    ...
    $('.rule_sure_lzm').click(function () {
        ...
        if(rule_name){
            $.ajax({
                type: 'POST',
                url: "/MeeZao/AutoReply/AutoReply/Edit_rule_name",
    ...
    $('.del_keywords_lzm').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/Del_keywords",
            data: 'del_id=' + del_id,
            success: function (data) {
                alert(data);
            },
    ...
    $("body").on("click", ".reply_del_text", function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/Del_autoreply_content",
    ...
    $("body").on("click", ".reply_del_img", function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/Del_autoreply_img",
            data: 'id=' + id + '&data_reply_id=' + data_reply_id,
            success: function (data) {
                alert(data);
            },
    ...
    $("body").on("click", ".reply_del_news", function () {
        ...
        $.ajax({
            type: 'POST',
            url: "/MeeZao/AutoReply/AutoReply/Del_autoreply_news",
            data: 'id=' + id + '&data_reply_id=' + data_reply_id,
            success: function (data) {
                alert(data);
            },
