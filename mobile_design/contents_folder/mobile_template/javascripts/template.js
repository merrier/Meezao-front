...
////---------------------验证码验证---------------------
//function codeSubmitVerification(){
//    var form = $("#elec_phone_engaged_register_form");
//    var phone = form.find("#elec_reg_phone").val();
//    var code = form.find("#elec_reg_code").val();
//    var status;
//
//    $.ajax({
//        dataType: "json",
...
//
////---------------------验证码请求发送---------------------
//function codeRequestVerification(){
//    var form = $("#elec_phone_engaged_register_form");
//    var phone = form.find("#elec_reg_phone").val();
//    var status;
//
